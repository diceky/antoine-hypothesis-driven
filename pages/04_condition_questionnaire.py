...
from utils import page_setup, get_group, save_widget
...
st.radio(
    ...
    format_func=(lambda x:
                 ["1 - No control/agency",
                  ...
                  "5 - Complete control/agency"][x-1]),
    captions=[
        ("You feel completely powerless or without influence over the "
         "outcome."),
        "",
...
if get_group() != "control":
    ...
    questions = [
        ...
        ("The AI is very reliable. I can count on it to be correct all the "
         "time."),
        ("I feel safe that when I rely on the AI I will get the right "
         "answers."),
