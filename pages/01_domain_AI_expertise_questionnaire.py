...
st.radio("Select your background",
         ["Resident",
          "Registrar",
          "Consultant"],
         index=None,
...
st.radio("How many years of experience do you have?",
         ["0-1 year",
          "2-4 years",
          "5-9 years",
          "10-14 years",
...
st.radio(("How often do you use Large Language Models (LLMs, e.g., "
...
st.radio("Have you ever studied anything related to AI?",
         ["Yes",
          "No"],
         index=None,
         key="ai_study")
...
questions = ["I am confident in the AI. I feel that it will work well.",
             "The outputs of the AI will be very predictable.",
             ("The AI will be very reliable. I can count on it to be "
              "correct all the time."),
             ("I feel safe that when I will rely on the AI I will get "
              "the right answers."),
             "The AI will be efficient in that it works very quickly.",
             "I am wary of the AI.",
             ("The AI will be able to perform the task better than a "
              "novice human user."),
...
if st.button("Next",
             disabled=(any([st.session_state[r] is None for r in results]))):
